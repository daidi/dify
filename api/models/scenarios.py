...
class Scenarios(db.Model):
    ...
    mock_id = db.Column(UUID, nullable=False)
    copilot_id = db.Column(UUID, nullable=False)
    summary_id = db.Column(UUID, nullable=False)
    mock_key = db.Column(db.String(255), nullable=False)
    copilot_key = db.Column(db.String(255), nullable=False)
